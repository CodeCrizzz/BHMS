...
<body class="bg-light d-flex flex-column h-100" style="overflow: hidden;">
    ...
    <div class="d-flex flex-grow-1" style="overflow: hidden;">
        ...
        <div class="sidebar p-3" style="width: 250px; overflow-y: auto;">
            <h4 class="text-center mb-4 mt-2">System Admin</h4>
            ...
            <a href="talk.php" class="active"><i class="fa fa-comments me-2"></i> Chat Support</a>
            ...
            <div class="bg-white border-end flex-shrink-0" style="width: 300px; overflow-y: auto;">
                ...
                <div class="list-group list-group-flush">
                    ...
                    while($t = $tenants->fetch_assoc()){
						...
						echo '<a href="?tenant_id='.$t['id'].'" class="list-group-item list-group-item-action '.$active.'">'.$t['fullname'].'</a>';
                    }
                    ?>
                </div>
            </div>
